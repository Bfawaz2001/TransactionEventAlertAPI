...
def test_event_three_consecutive_withdrawals(client):
    client.post('/event', json={"type": "withdraw", "amount": "50.00", "user_id": 2, "time": 5})
    client.post('/event', json={"type": "withdraw", "amount": "30.00", "user_id": 2, "time": 10})
    response = client.post('/event', json={"type": "withdraw", "amount": "70.00", "user_id": 2, "time": 15})
...
def test_event_non_sequential_time(client):
    client.post('/event', json={"type": "deposit", "amount": "50.00", "user_id": 1, "time": 10})
    response = client.post('/event', json={"type": "deposit", "amount": "60.00", "user_id": 1, "time": 5})  # Time goes backward
...
def test_event_three_consecutive_increasing_deposits(client):
    client.post('/event', json={"type": "deposit", "amount": "50.00", "user_id": 3, "time": 10})
    client.post('/event', json={"type": "deposit", "amount": "60.00", "user_id": 3, "time": 20})
    response = client.post('/event', json={"type": "deposit", "amount": "70.00", "user_id": 3, "time": 30})
...
def test_event_deposits_exceeding_200_in_30_seconds(client):
    client.post('/event', json={"type": "deposit", "amount": "100.00", "user_id": 4, "time": 10})
    client.post('/event', json={"type": "deposit", "amount": "120.00", "user_id": 4, "time": 25})
    response = client.post('/event', json={"type": "deposit", "amount": "100.00", "user_id": 4, "time": 30})
...
def test_event_deposits_spread_out_no_alert(client):
    client.post('/event', json={"type": "deposit", "amount": "100.00", "user_id": 5, "time": 10})
    response = client.post('/event', json={"type": "deposit", "amount": "120.00", "user_id": 5, "time": 45})
